...
export default function SkillAssignment({ onAssignmentComplete }: SkillAssignmentProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        <div className="mb-4">
          <h3 className="text-lg font-semibold text-gray-900 mb-2">Assignment Mode</h3>
          <div className="flex space-x-4">
            <label className="flex items-center">
              <input
                ...
                onChange={(e) => setAssignmentMode(e.target.value as 'individual' | 'bulk')}
                className="mr-2"
              />
          ...
          <p className="text-sm text-gray-600 mt-2">
            {assignmentMode === 'individual' 
              ? 'Select one member at a time for precise skill assignment.'
              : 'Select multiple members to assign skills to groups or all members.'
            }
          </p>
        </div>
      </Card>
