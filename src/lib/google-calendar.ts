...
function createOAuthClient() {
  ...
  console.log('Creating OAuth client with:', {
    ...
    clientSecret: process.env.GOOGLE_CLIENT_SECRET ? `SET (length: ${process.env.GOOGLE_CLIENT_SECRET.length}, starts with: ${process.env.GOOGLE_CLIENT_SECRET.substring(0, 10)}...)` : 'NOT SET',
